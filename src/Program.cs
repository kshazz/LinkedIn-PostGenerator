...
if (!File.Exists(csvPath))
{
    Console.WriteLine($"❌ File not found at: {csvPath}");
    return;
}

Console.WriteLine($"✅ Using CSV found at: {csvPath}");
...
if (nextTopic == null)
{
    Console.WriteLine("✅ All topics in the CSV have already been drafted.");
    return;
}
...
try
{
    ...
    string prompt = $"""
        ...
        Signature: 🚀 #asp.net core #dotnet #csharp #azure
        """;
    ...
    {
        Console.WriteLine("⚠️ Model returned an empty response.");
        return;
    }
    ...
    var mail = new MailMessage
    {
        ...
        Subject = $"✨ LinkedIn Draft: {nextTopic.Title}",
    ...
    Console.WriteLine("💾 topics.csv updated.");
}
catch (Exception ex)
{
